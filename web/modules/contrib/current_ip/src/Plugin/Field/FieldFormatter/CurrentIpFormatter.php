...
namespace Drupal\current_ip\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'current_ip' formatter.
 *
 * @FieldFormatter(
 *   id = "current_ip",
 ...
 * )
 */
class CurrentIpFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
